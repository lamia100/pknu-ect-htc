...
public final class ParseCarte {	
	...
	public static WeeklyCarte getWeeklyCarteD() {
		return parseWeeklyCarte(Const.WEEKLY_CARTE_URL_D, Const.MONTHLY_CARTE_TABLE_INDEX_LIST);
	}
	
	public static WeeklyCarte getWeeklyCarteY() {
		return parseWeeklyCarte(Const.WEEKLY_CARTE_URL_Y, Const.MONTHLY_CARTE_TABLE_INDEX_LIST);
	}
